...
if '__main__' == __name__:
    ...
    net.addLink(s3, h3, cls=TCLink, **linkopt)
    ...
    r1.cmd("ifconfig r1-eth3 10.0.2.1 netmask 255.255.255.0")
    ...
    h3.cmd("ip route add default scope global nexthop via 10.0.3.1 dev h3-eth0")
